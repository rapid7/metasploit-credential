...
- [ ] Add an item to each category's list in the following format: `[#<PR>](https://github.com/rapid7/metasploit-credential/pull/<PR>) <consumer summary> - [@<github_user>](https://github.com/<github_user>)`
...
[`PATCH`](lib/metasploit/credential/version.rb).

### Compatible API changes

If the [CHANGELOG.md](CHANGELOG.md) contains any Enhancements or Deprecations, then increment
[`MINOR`](lib/metasploit/credential/version.rb) and reset [`PATCH`](lib/metasploit/credential/version.rb) to `0`.

### Incompatible API changes

If the [CHANGELOG.md](CHANGELOG.md) contains any Incompatible Change, then increment [`MAJOR`](lib/metasploit/credential/version.rb) and
reset [`MINOR`](lib/metasploit/credential/version.rb and [`PATCH`](lib/metasploit/credential/version.rb) to `0`.
