...
increment [`PATCH`](lib/metasploit/credential/version.rb).
...
1. To remain pre-1..0.0, then increment [`MINOR`](lib/metasploit/credential/version.rb) and reset [`PATCH`](lib/metasploit/credential/version.rb) to `0`.
2. To advance to 1.0.0, increment [`MAJOR`](lib/metasploit/credential/version.rb) and reset [`MINOR`](lib/metasploit/credential/version.rb and [`PATCH`](lib/metasploit/credential/version.rb) to `0`.
