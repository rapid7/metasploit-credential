...
CREATE TABLE nexpose_result_exceptions (
    ...
    state character varying(255),
    nexpose_response character varying(255)
);
...
--
-- Name: ssl_certs; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
CREATE SEQUENCE ssl_certs_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE ssl_certs_id_seq OWNED BY ssl_certs.id;
...
ALTER TABLE ONLY ssl_certs ALTER COLUMN id SET DEFAULT nextval('ssl_certs_id_seq'::regclass);
...
--
-- Name: se_portable_files_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: se_target_list_human_targets_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: se_target_lists_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: ssl_certs_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY ssl_certs
...
INSERT INTO schema_migrations (version) VALUES ('20150126191220');

INSERT INTO schema_migrations (version) VALUES ('20150205192745');

INSERT INTO schema_migrations (version) VALUES ('20150206170204');

INSERT INTO schema_migrations (version) VALUES ('20150206201513');
...
INSERT INTO schema_migrations (version) VALUES ('20150225173656');

INSERT INTO schema_migrations (version) VALUES ('20150226151459');

INSERT INTO schema_migrations (version) VALUES ('20150302212619');

INSERT INTO schema_migrations (version) VALUES ('20150310151024');
...
INSERT INTO schema_migrations (version) VALUES ('20150406194935');
